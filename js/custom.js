...
jQuery(document).ready(function(){
  ...
  if(jQuery(".modal").length) {
	...
	jQuery(".modal a[rel^='modal']").click(function(e) {
		var msg = jQuery(this).attr('data-rel');
        jQuery("#form-solicitar form textarea").html('Solicito mais informações sobre o ' + msg + '. Por favor entrem em contato comigo.');		 
    });
	
	jQuery(".modal a[rel^='modal']").prettyPhoto({animation_speed:'normal',theme:'light_square',slideshow:3000, autoplay_slideshow: false,social_tools: false, default_width: 720, default_height: 400,});
