<?php 
/*
Template Name: Solicitar Notificação
*/
                ...
                <form method="post" id="solicitar">
                    ...
                    <p class="clear">
                    	<?php
								...
								$msg = "Olá. Eu gostaria de ser informado sempre que houver disponível novas cartas contempladas atravéz do meu email ou telefone.";	
							
                    	?>
                        Mensagem:
                        <textarea name="mensagem" id="msg" placeholder="Mensagem" cols="5" rows="3" readonly="readonly"><?php echo $msg; ?></textarea>
                    </p>
